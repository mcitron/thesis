...
\begin{abstract}%[\smaller \thetitle\\ \vspace*{1cm} \smaller {\theauthor}]
  ...
  Dedicated dimensionless variables ensure backgrounds with fake missing energy are mitigated. A detailed description 
  is given of the selections used to mitigate backgrounds while maintaining signal acceptance to a wide range of models as well
  as the techniques used to ensure a robust determination of the residual backgrounds and systematic uncertainties.
  ...
  Additionally, a study is presented into the upgrade of the Level-1 trigger jet and energy sum algorithm.
  The upgraded trigger hardware is exploited to ensure effective performance in conditions exceeding 
