...
\newcommand{\htalphat}{\texttt{\scalht\_AlphaT}\xspace}
\newcommand{\htcat}{\ensuremath{\scalht^{\text{cat}}}\xspace}
\newcommand{\photon}{\texttt{Photon}\xspace}
\newcommand{\muht}{\texttt{Mu\_\scalht}\xspace}
\newcommand{\httrigger}{\texttt{\scalht}\xspace}
\newcommand{\mt}{\ensuremath{M_{\textrm{T}}}\xspace}
\newcommand{\gj}{\ensuremath{\gamma} + jets\xspace}
\newcommand{\dy}{\ensuremath{q\bar{q}\rightarrow Z/\gamma^{*}\rightarrow l^{+}l^{-}}\xspace}
\newcommand{\mj}{\ensuremath{\mu} + \textrm{jets}\xspace}
\newcommand{\mmj}{\ensuremath{\mu\mu} + \textrm{jets}\xspace}
\newcommand{\lj}{\ensuremath{\ell} + \textrm{jets}\xspace}
\newcommand{\llj}{\ensuremath{\ell\ell} + \textrm{jets}\xspace}
...
\newcommand{\nsim}{\ensuremath{N_{\textrm{sim}}}\xspace}
...
\newcommand{\ttW}{\ensuremath{\ttbar\text{W}}\xspace}
\newcommand{\ttV}{\ensuremath{\ttbar\xspace\text{V}}\xspace}
\newcommand{\ttZ}{\ensuremath{\ttbar\text{Z}}\xspace}
...
\newcommand{\wl}{\ensuremath{{\rm{W}}\rightarrow{\text{l}}\nu}\xspace}
\newcommand{\tlb}{\ensuremath{{\rm{t}}(\rightarrow{\rm l}\nu) + b}\xspace}
\newcommand{\twb}{\ensuremath{{\rm{t}}\rightarrow\textrm{W}+ b}\xspace}
\newcommand{\wmj}{\ensuremath{{\rm{W}}(\rightarrow\mu\nu) + \textrm{jets}}\xspace}
\newcommand{\zj}{\ensuremath{{\rm{Z}} + \textrm{jets}}\xspace}
\newcommand{\dyj}{Drell-Yan + jets\xspace}
...
\newcommand{\Lonept}{\ensuremath{{p_{\text T}^{\text{L1}}}}\xspace}
\newcommand{\Genpt}{\ensuremath{{p_{\text T}^{\text{Gen}}}}\xspace}
...
\newcommand{\chiz}{\ensuremath{\chi^{0}}\xspace}
\newcommand{\chip}{\ensuremath{\chi^{+}}\xspace}
...
% \def\metvec{\mbox{$\vec{\pt}^\text{miss}$}\xspace}
...
%\def\mht{\mbox{$\hslash_\text{T}$}\xspace}
\def\mht{\mbox{$\,\cancel{H}_{\rm T}$}\xspace}
% \def\cm{\mbox{$\,\text{cm}$}\xspace}
% \def\mum{\mbox{$\,\text{\mu m}$}\xspace}
\def\mm{\ensuremath{\,\text{mm}}}
\def\mum{\ensuremath{\,\mu\text{m}}}
\def\cm{\ensuremath{\,\text{cm}}}
\def\mhtvec{\mbox{$\vec{\cancel{H}}_{\rm T}$}\xspace}
\def\metvec{\mbox{$\vec{\cancel{E}}^{\,\text{PF}}_{\rm T}$}\xspace}
\def\metveccalo{\mbox{$\vec{\cancel{E}}^{\,\text{calo}}_{\rm T}$}\xspace}
...
\def\htmiss{\mbox{$H_\text{T}^{\text{miss}}$}\xspace}
\def\etmiss{\mbox{$\eslash_\text{T}$}\xspace}
\def\mtt{\mbox{$\rm{M}_\text{T2}$}\xspace}
\def\rmec{\mbox{$R_{\mht/\met}$}\xspace}
\def\bdphi{\mbox{$\Delta\phi^{*}_{\rm min}$}\xspace}
\def\jbdphi{\mbox{$j_{\bdphi}$}\xspace}
...
\def\psiR{\ensuremath{\psi_{\mathrm{R}}}}
\def\psiL{\ensuremath{\psi_{\mathrm{L}}}}
\def\psiRb{\ensuremath{\bar{\psi}_{\mathrm{R}}}}
\def\psiLb{\ensuremath{\bar{\psi}_{\mathrm{L}}}}
\def\LUV{\ensuremath{\Lambda_{\mathrm{UV}}}}
\newcommand{\rhoG}{\ensuremath{\rho_{\text{global}}}\xspace}
\newcommand{\rhoP}{\ensuremath{\rho_{\text{pileup}}}\xspace}
\newcommand{\rhoD}{\ensuremath{\rho_{\text{doughnut}}}\xspace}
\newcommand{\rhoC}{\ensuremath{\rho_{\text{chunky}}}\xspace}
