...
\makebox[0pt]{
  \subfloat[Variation in \ttbar/W~simulation]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/mcSystematics12p9fb/Ttw/mu/ratioh_ht_mht_alltopPtWeight_Up.pdf}
  } ~~
  \subfloat[Variation in \mj~to \ttbar/W~transfer factor]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/mcSystematics12p9fb/Ttw/mu/ratiotfh_ht_mht_alltopPtWeight_Up.pdf}
  }}\\
  \caption{\label{fig:tfSimVar} The relative change in each category in the
  \ttbar/W simulation, (a), compared to the relative change in the $\mj \rightarrow (\ttbar/W)$ transfer
  factor, (b), when varying the top \pt~uncertainty to $+1\sigma$. The y axis shows the \njet, \nb~
    category while the x axis shows the \scalht category.
  }
\end{figure}
...
\makebox[0pt]{
  \subfloat[Simulated QCD events in the signal region.\label{fig:qcd_pass}]{
    \includegraphics[width=0.6\textwidth]{Figures/qcd/plots/signalQCD_MC}
  } ~
  \subfloat[Simulated QCD events in the \mhtmet~hadronic control region.\label{fig:qcd_fail}]{
    \includegraphics[width=0.6\textwidth]{Figures/qcd/plots/qcdSbQCD_MC}
  }} \\
\makebox[0pt]{
  \subfloat[Transfer factor from simulated QCD events.\label{fig:qcd_ratio}]{
    \includegraphics[width=0.6\textwidth]{Figures/qcd/plots/signalQcdDivSbQcd_MC}
  } ~ 
  \subfloat[Simulated electroweak events in \mhtmet~hadronic control region.\label{fig:ewk_fail}]{
    \includegraphics[width=0.6\textwidth]{Figures/qcd/plots/qcdSbEwk_MC}
...
\makebox[0pt]{
  \subfloat[Predicted QCD counts in the \mhtmet hadronic control region.\label{fig:data_corr}]{
    \includegraphics[width=0.6\textwidth]{Figures/qcd/plots/postFitQcdYields_QcdSb}
  } ~
  \subfloat[QCD multijet predictions in the signal region.\label{fig:qcd_pred}]{
    \includegraphics[width=0.6\textwidth]{Figures/qcd/plots/predictedQcdYields_Signal}
  }} \\
  \subfloat[Ratio of predicted multijet and non-multijet yields.\label{fig:qcd_ewk_ratio}]{
    \includegraphics[width=0.6\textwidth]{Figures/qcd/plots/predictedQcdDivEwk_Signal}
  } \\
  \caption{
...
\begin{figure}[h!]
  \begin{center}        
    \includegraphics[width=0.8\textwidth]{figures/qcd/plots/doubleQcdSbSrRatio1D}
    \caption{ Ratio of the measurement of \rmhtmet, 
the pass/fail ratio for the \mhtmet~selection, from data and Monte Carlo in the $\bdphi < 0.5$ sideband in (\scalht, \njet) bins.  
    }
    \label{fig:RR_qcd}
  \end{center} 
\end{figure}
...
\makebox[0pt]{
  \subfloat[\mj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/SingleMu/fitOut/Linear2DShiftMean/pull_Linear2DShiftMean_p1_SingleMu.pdf}
  }~~
  \subfloat[\gj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/SinglePhoton/fitOut/Linear2DShiftMean/pull_Linear2DShiftMean_p1_SinglePhoton.pdf}
  }}\\
  \subfloat[\mmj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/DoubleMu/fitOut/Linear2DShiftMean/pull_Linear2DShiftMean_p1_DoubleMu.pdf}
  }~~
  \\
...
\makebox[0pt]{
  \subfloat[\mj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/SingleMu/fitOut/Linear2DShiftMean/frenchFlagPull_Linear2DShiftMean_p1_SingleMu.pdf}
  }~~
  \subfloat[\gj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/SinglePhoton/fitOut/Linear2DShiftMean/frenchFlagPull_Linear2DShiftMean_p1_SinglePhoton.pdf}
  }}\\
  \subfloat[\mmj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/DoubleMu/fitOut/Linear2DShiftMean/frenchFlagPull_Linear2DShiftMean_p1_DoubleMu.pdf}
  }~~
  \\
...
\makebox[0pt]{
  \subfloat[\mj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/SingleMu/fitOut/Linear2DShiftMean/pValue_Linear2DShiftMean_SingleMu.pdf}
  }~~
  \subfloat[\gj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/SinglePhoton/fitOut/Linear2DShiftMean/pValue_Linear2DShiftMean_SinglePhoton.pdf}
  }}\\
  \subfloat[\mmj]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/DoubleMu/fitOut/Linear2DShiftMean/pValue_Linear2DShiftMean_DoubleMu.pdf}
  }~~
  \\
...
\makebox[0pt]{
  \subfloat[\label{fig:expectedTtw} Expected uncertainties]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12FbMC/scale_ht_variable_mht/Ttw/fitOut/Linear2DShiftMean/frenchFlagErrComplete_Linear2DShiftMean_p1_Ttw.pdf}
  }~~
  \subfloat[\label{fig:observedTtw} Observed uncertainties]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/Ttw/fitOut/Linear2DShiftMean/frenchFlagErrComplete_Linear2DShiftMean_p1_Ttw.pdf}
  }}\\
...
\makebox[0pt]{
  \subfloat[\label{fig:expectedZinv} Expected uncertainties]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12FbMC/scale_ht_variable_mht/Zinv/fitOut/Linear2DShiftMean/frenchFlagErrComplete_Linear2DShiftMean_p1_Zinv.pdf}
  }~~
  \subfloat[\label{fig:observedZinv} Observed uncertainties]{
    \includegraphics[width=0.6\textwidth]{Figures/backgroundPrediction/shapeOutput12Fb/scale_ht_variable_mht/Zinv/fitOut/Linear2DShiftMean/frenchFlagErrComplete_Linear2DShiftMean_p1_Zinv.pdf}
  }}\\
