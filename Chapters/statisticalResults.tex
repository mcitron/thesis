...
\begin{figure}[!tbhp]
  \begin{center}
  \makebox[0pt]{
    \subfloat[\label{pullsCR}]{\includegraphics[width=0.6\textwidth]{Figures/statisticalResults/pulls_all_CR}}~
    \subfloat[\label{pullsCRLV}]{\includegraphics[width=0.6\textwidth]{Figures/statisticalResults/pulls_all_CR_freezeLV}}
}
  \end{center}
  \caption{
