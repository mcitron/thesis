...
\subfigure[Input resolution: TMT]{\includegraphics[width=0.35\textwidth]{./Figures/triggerUpgrade/L1inputresupgrade.png}\label{subfig:inputupgrade}} 
...
\begin{figure}
\begin{center}
\subfigure[All jets\label{fig:label:alljet}]{\includegraphics[width=0.4\textwidth]{./Figures/triggerUpgrade/alljet}}
\subfigure[4th jet\label{fig:label:jet4}]{\includegraphics[width=0.4\textwidth]{./Figures/triggerUpgrade/jet4}}
...
\begin{figure}[h!]
  \centering
    \subfigure[]{\includegraphics[width=0.4\textwidth]{./Figures/triggerUpgrade/singleJet_150.png}}~
    \subfigure[]{\includegraphics[width=0.4\textwidth]{./Figures/triggerUpgrade/doubleJet_110.png}}\\
