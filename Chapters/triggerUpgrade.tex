...
At 25ns bunch spacing an average of 25 simlutaneous interactions are produced per bunch crossing.
The high luminosity and pileup provides a challenging environment for the L1 trigger system
during Run 2, which must continue to provide an input rate to the HLT of 100kHz, which 
exceeds design specifications. Simply increasing thresholds on the L1 trigger seeds would cause
unacceptable inefficiencies for electroweak physics and \TeV~scale searches
at CMS and the L1 trigger system, and associated algorithms, must therefore be upgraded. 
...
The difference between the GCT (and UCT) and TMT architectures is shown schematically in Figure~\ref{tmux}. 
...
\begin{figure}
\centering
\subfigure[Input resolution: GCT]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/L1inputreslegacy.png}\label{subfig:inputlegacy}} \quad
\subfigure[Input resolution: TMT]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/L1inputresupgrade.png}\label{subfig:inputupgrade}} 
...
In order to ensure that jets do not overlap such that energy deposits are double counted, 
the seed tower is required to meet the conditions
...
If a seed passes the veto requirements a jet is defined with the position 
given by the seed tower and an energy given by the total energy of the towers. 
The seed position is used as jets tend to be boosted objects with an energy deposited in
...
top pair-production \footnote{In this section all simulated samples used have conditions 
...
\begin{figure}
\hfill
\subfigure[Doughnut rings\label{fig:donut}]{\includegraphics[width=7cm]{./Figures/triggerUpgrade/donut}}
\hfill
\subfigure[Chunky doughnut rings\label{fig:chunkyDonut}]{\includegraphics[width=7cm]{./Figures/triggerUpgrade/chunkyDonut}}
\hfill
...
Efficiencies are measured using a simulated top pair production sample while 
...
\begin{figure}
\begin{center}
\subfigure[All jets\label{fig:label:alljet}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/alljet}}
\subfigure[4th jet\label{fig:label:jet4}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/jet4}}
...
a simulated top pair production sample. The resolution is flat near unity when pileup subtraction is applied,
...
\begin{figure}
    \begin{center} 
	\subfigure[\label{fig:resolution1}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/resolution}}~
	\subfigure[\label{fig:resolution2}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/p1eta_14to28_calib_fits}}
...
\begin{figure}
    \begin{center} 
	\subfigure[\label{fig:resolution1}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/leadJet150_noUct}}~
	\subfigure[\label{fig:resolution2}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/fourthJet100_noUct}}
...
\begin{figure}[h!]
  \centering
    \subfigure[]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/singleJet_150.png}}~
    \subfigure[]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/doubleJet_110.png}}\\
...
\begin{figure}
\centering
	\subfigure[]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/ht_200}\label{fig:ht_rateEff}}~
	\subfigure[]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/mht_200}\label{fig:mht_rateEff}}
...
\begin{figure}
\centering
	\subfigure[]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/xy_SingleMu_jetEt_vs_l1JetEt_barrel-endcap}}~
	\subfigure[]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/res_SingleMu_jetEt_over_l1JetEt_barrel-endcap_puBins}}
...
\begin{figure}
\centering
	\subfigure[Upgrade trigger]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/noHardBin12JetdphiFullS2}}~
	\subfigure[UCT]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/noHardBin12JetdphiFullUCT}}
...
\begin{figure}
\centering
	\subfigure[Upgrade trigger]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/noHardBin1ge4JetdphiFullS2}}~
	\subfigure[UCT]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/noHardBin1ge4JetdphiFullUCT}}
