...
\begin{figure}
    \begin{center} 
	\subfigure[\label{fig:ht_rateEff}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/ht_200}}~
	\subfigure[\label{fig:mht_rateEff}]{\includegraphics[width=0.5\textwidth]{./Figures/triggerUpgrade/mht_200}}
