...
These are grouped into $4\times4$ \emph{calorimeter regions} that form the input for physics object and
...
scatter and cause \emph{pileup jets} to be clustered 
...
relatively small area sampled. An extension, \emph{chunky} doughnut, shown in Figure~\ref{fig:chunkyDonut},
...
\begin{figure}
\begin{center}
\subfigure[]{\includegraphics[width=0.45\textwidth]{./Figures/triggerUpgrade/alljet}}
\subfigure[]{\includegraphics[width=0.45\textwidth]{./Figures/triggerUpgrade/jet4}}
