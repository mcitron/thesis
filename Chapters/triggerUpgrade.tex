...
\begin{figure}
    \begin{center} 
	\subfloat[\label{fig:turnon1}]{\includegraphics[width=0.45\textwidth]{./Figures/triggerUpgrade/leadJet150_noUct}}~
	\subfloat[\label{fig:turnon2}]{\includegraphics[width=0.45\textwidth]{./Figures/triggerUpgrade/fourthJet100_noUct}}
...
are achievable with the upgraded system. The maximal efficiency gain in using $\pi - |\Delta\phi_{1,2}|$ to 
