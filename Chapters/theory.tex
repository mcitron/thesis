...
are included for either the gauge bosons or the fermions. These cannot be included directly as any such terms break 
the gauge invariance. As shown in the remainder of this section, such masses must be introduced via the breaking
...
can resolve some or all of the outstanding issues in the SM. Supersymmetry (SUSY) is a particularly
...
The SM Higgs does not reside in a single chiral supermultiplet as a gauge anomaly
would be introduced into the theory~\cite{SUSYP}. This may be avoided by including two Higgs 
...
%The overall correction to the Higgs boson mass will therefore be (neglecting terms not dependent on \lambda)
